...
case class SidewalkVertexBuilderManager() {
  ...
  def create(coordinate: Coordinate, streetVertexBelongTo: StreetVertex[StreetEdge], key1: String, key2: String): SidewalkVertexBuilder = this.synchronized {
  ...
  def createForSingle(coordinate: Coordinate, streetVertexBelongTo: StreetVertex[StreetEdge], key1: String): SidewalkVertexBuilder = {
 ...
 */
case class SidewalkVertexBuilder(coordinate: Coordinate, streetVertexBelongTo: StreetVertex[StreetEdge]) {
