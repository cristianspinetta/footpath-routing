...
#    if git diff-index --quiet HEAD --; then
        ...
        scp -i ~/.ssh/easy-travel-amazon.pem navigation-api/target/scala-2.11/footpath-routing-api.jar ubuntu@ec2-54-187-107-69.us-west-2.compute.amazonaws.com:~/app/
        ssh -i ~/.ssh/easy-travel-amazon.pem ubuntu@ec2-54-187-107-69.us-west-2.compute.amazonaws.com "~/app/scripts/shutdown && ~/app/scripts/startup"
